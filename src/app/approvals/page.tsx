        ...
        <div className="flex flex-col gap-6 p-5 sm:p-6 lg:flex-row lg:items-end lg:justify-between lg:p-8">
          ...
          <div className="flex w-full flex-col gap-3 lg:w-auto lg:min-w-[280px] lg:max-w-sm">
            <div className="rounded-2xl border border-white/70 bg-white/80 p-4 shadow-[0_12px_32px_rgba(239,68,68,0.12)] backdrop-blur">
              ...
              <div className="mt-4 rounded-2xl border border-zinc-200/80 bg-zinc-50/80 p-3 text-sm text-zinc-600">
                {pending.length > 0
            ...
            {pending.map((a) => {
              ...
              return (
                <Card key={a.id} variant="featured" className="relative overflow-hidden rounded-[24px]">
                  <div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-red-500 via-red-500 to-amber-400 opacity-80" />
                  <CardContent className="flex h-full flex-col gap-5 p-5 sm:p-6">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="shrink-0 rounded-2xl border border-zinc-200/80 bg-white/80 px-3 py-2 text-right shadow-sm">
                    ...
                    <div
                      ...
                      className="sticky bottom-16 z-40 flex flex-col gap-2 border-t border-zinc-100 bg-white/95 pt-4 backdrop-blur md:static md:border-0 md:bg-transparent md:p-0 md:backdrop-blur-none lg:flex-row"
                    >
                      <Button
                        type="submit"
                        form={`form-${a.id}`}
        ...
        {resolved.length === 0 ? (
          ...
          <div className="grid gap-3 xl:grid-cols-2">
            {resolved.map((a) => {
              ...
              return (
                <div key={a.id} className="rounded-[24px] border border-zinc-200 bg-white p-5 shadow-sm">
                  <div className="flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      ...
                      <div className="mt-3 grid gap-2 text-sm text-zinc-500 sm:grid-cols-2">
                        <div className="rounded-2xl border border-zinc-200 bg-zinc-50/70 px-3 py-2">
                          <div className="text-[11px] font-medium uppercase tracking-[0.14em] text-zinc-400">Project</div>
                      ...
                      {a.note ? (
                        <div className="mt-3 rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm leading-6 text-zinc-600 shadow-sm">
                    ...
                    <div className="shrink-0 rounded-2xl border border-zinc-200/80 bg-zinc-50/80 px-3 py-2 text-right text-xs text-zinc-500 shadow-sm">
