...
export default function NewProjectPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[radial-gradient(circle_at_top_left,rgba(254,226,226,0.42),rgba(255,255,255,0.98)_34%,rgba(255,243,229,0.56)_72%,rgba(255,250,245,0.94)_100%)] px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="rounded-[32px] border border-red-100/70 bg-white/72 p-8 shadow-[0_18px_56px_rgba(24,24,27,0.06)] backdrop-blur">
          ...
          <div className="mt-5 max-w-xl space-y-3">
            ...
            <p className="text-sm leading-6 text-zinc-600 sm:text-base">
              This route keeps the shared warm-brand backdrop, but with a calmer presentation so the intake flow feels cleaner and more product-grade.
            </p>
          </div>
        </div>
      </div>
