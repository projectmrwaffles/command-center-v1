    ...
    <div className="space-y-6 md:space-y-8">
        ...
        <div className="flex flex-col gap-6 p-5 sm:p-6 lg:flex-row lg:items-end lg:justify-between lg:p-8">
          <div className="max-w-2xl space-y-4">
            ...
            <div className="space-y-2">
              <h1 className="text-3xl font-semibold tracking-tight text-text sm:text-4xl">Projects</h1>
          ...
          <div className="flex w-full flex-col gap-3 lg:w-auto lg:min-w-[260px] lg:items-end">
            ...
            {stats.completed > 0 ? <p className="px-1 text-xs text-text-muted">{stats.completed} completed project{stats.completed === 1 ? "" : "s"} in the archive-ready set.</p> : null}
          </div>
        </div>
      </PageHero>
      ...
      {loading ? (
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="animate-pulse rounded-[24px] border border-border bg-panel p-5 shadow-sm">
              <div className="mb-4 flex items-center justify-between">
                <div className="h-5 w-24 rounded-full bg-panel-elevated" />
                <div className="h-5 w-20 rounded-full bg-panel-elevated" />
              </div>
              <div className="mb-3 h-6 w-2/3 rounded bg-panel-elevated" />
              <div className="space-y-2">
                <div className="h-4 w-full rounded bg-panel-elevated" />
                <div className="h-4 w-5/6 rounded bg-panel-elevated" />
              </div>
              <div className="mt-5 h-2 w-full rounded-full bg-panel-elevated" />
            </div>
          ))}
        </div>
      ) : error ? (
