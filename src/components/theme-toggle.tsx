...
export function ThemeToggle({ className }: { className?: string }) {
  ...
  return (
    <div className={cn("flex items-center justify-between gap-3 rounded-2xl border border-border bg-panel px-3 py-2 shadow-[var(--shadow-panel-soft)]", className)}>
      <div>
      ...
      <div className="inline-flex rounded-xl border border-border bg-shell p-1">
